...
public $_fields = array(
	...
	"type" => array("label"=>"Type de compte", "type"=>"select", "list"=>array("superadmin"=>"Super administrateur", "admin"=>"Administrateur", "redac"=>"Rédacteur", "user"=>"Associé", "client"=>"Client")),
